...
NEW plan. 
Have methods defined outside the class then call them two ways like numpy
a=a.croptext()
or 
a=kermit.croptext(a)
"""
...
class KerrArray(np.ndarray):
    ...
    def __new__(cls, image, metadata={}, get_metadata=False, datatype='float'):
        """
    ...
    def __init__(self, image, metadata={}, get_metadata=False, datatype='float'):
